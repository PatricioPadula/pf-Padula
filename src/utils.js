...
//configuración para almacenar las imagenes de los usuarios
const profileStorage = multer.diskStorage({
    //donde guardar los archivos
    destination: function(req,file,cb){
        cb(null,path.join(__dirname,"/multer/users/img"))
    },
    //con que nombre vamos a guardar ese archivo
...
//configuración para almacenar las imagenes de los productos
const productsStorage = multer.diskStorage({
    ...
    //con que nombre vamos a guardar ese archivo
    filename: function(req,file,cb){
        cb(null, `${req.body.email}-product-${file.originalname}`)
    }
})

//creamos uploader de imagenes de productos
export const uploaderProduct = multer({storage:productsStorage})

//configuración para almacenar los documentos de los usuarios
